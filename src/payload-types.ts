...
export interface CustomerOfferSettingsSelect<T extends boolean = true> {
  ...
  customerEntryPercentageOfferAvailableToDate?: T;
  customerEntryPercentageOfferDailyStartTime?: T;
  customerEntryPercentageOfferDailyEndTime?: T;
  customerEntryPercentageOfferGivenCount?: T;
  customerEntryPercentageOfferCustomerCount?: T;
  customerEntryPercentageOfferCustomers?: T;
  customerEntryPercentageOfferCustomerUsage?:
    | T
    | {
        customer?: T;
