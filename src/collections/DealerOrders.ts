...
const DealerOrders: CollectionConfig = {
  slug: 'dealer-orders',
  admin: {
    useAsTitle: 'orderNumber',
    defaultColumns: ['orderNumber', 'dealer', 'date', 'status', 'createdByName'],
  },
  access: {
    read: () => true,
    create: () => true,
        ...
        if (operation === 'create') {
          ...
          if (req.user) {
            ...
            if (!data.createdByName) {
              ...
              data.createdByName = u.name || u.username || u.email || 'Store Keeper'
            }
          }
        }
